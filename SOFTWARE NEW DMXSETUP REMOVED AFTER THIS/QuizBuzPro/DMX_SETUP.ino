void DMX_SETUP(){
    ...
    while (str != "exit" ) {
          ...
          while ( TC == 0 ) { 
           ...
           if ( Table != 0 and Table != 1 and Table != 2 and Table != 3 and Table != 4 and Table != 5 and Table != 6 and Table != 7 and Table != 8 and Table != 9 and Table != 10 ){ Serial.print("Wrong Entry "); Serial.println(Table); TG=0;} 
          ...
          if ( Table == 7 ) { FIXTURE_SELECT(); goto Menu; }
          if ( Table == 8 ) { FIXTURE_DRIVE(); goto Menu; }
          if ( Table == 9 ) { LAMP_CHECK(); BUTTON_CHECK(); goto Menu; }
          if ( Table == 10 ) {break;}
